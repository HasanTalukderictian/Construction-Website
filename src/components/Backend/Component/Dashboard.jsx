...
//                         <div className="card-body">
//                             <h5 className="card-title">Pie Chart</h5>
//                             <div className="pie-chart" style={{ marginTop: '5px', width: '400px', height: '300px', marginLeft: 'auto', marginRight: 'auto' }}>
//                                 <Pie
//                                     data={pieData}
//                                     options={{
    ...
    return (
        <div className="container mt-1 border-2 bg-gradient-secondary">
            ...
            <div className="row g-4">
                {/* Cards Section */}
                {[
                    { title: "Total Blogs", value: dashboardData.blogs, className: "card-title-blogs", color: "bg-primary" },
                    { title: "Total Services", value: dashboardData.services, className: "card-title-services", color: "bg-success" },
                    { title: "Total Projects", value: dashboardData.projects, className: "card-title-projects", color: "bg-warning text-dark" },
                    { title: "Total Testimonials", value: dashboardData.testimonials, className: "card-title-testimonials", color: "bg-info" },
                    { title: "Total Teams", value: dashboardData.teams, className: "card-title-teams", color: "bg-secondary" },
                    { title: "Total Employee", value: dashboardData.employee, className: "card-title-employee", color: "bg-success" },
                ].map((card, index) => (
                    <div className="col-lg-3 col-md-6" key={index}>
                        <div className={`card text-center ${card.color} text-white`}>
                            <div className="card-body">
